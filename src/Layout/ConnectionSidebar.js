...
import ConnectionsTree
  from "../Components/Sidebar/ConnectionsTree/ConnectionsTree";
//import ConnectionsTree from
// "../Components/Sidebar/ConnectionsTree/ConnectionsTree";
        ...
        <Container className='sidebarContainer'>
            ...
            <Segment raised color='grey' className='connectionList'>
                <Button icon='refresh'
                        ...
                        //loading={appState.connectionsLoading ||
                  // appState.ticketsLoading}
                        onClick={() => {
